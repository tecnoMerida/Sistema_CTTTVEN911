...
if(isset($_POST)){ // Asignamos valores a las variables del POST
                              // Tabla "Solicitante"
              if (is_null($_POST['p_nombre_sol'])){
                $p_nombre_sol = n;
              }else{
                $p_nombre_sol = strtoupper($_POST['p_nombre_sol']);
              }

              if (is_null($_POST['p_apellido_sol'])){
                $p_apellido_sol = n;
              }else{
              ...
              if (is_null($_POST['motivo_solicitud_id'])){
                $motivo_solicitud_id = 0;
              }else{
                $motivo_solicitud_id = $_POST['motivo_solicitud_id'];
              }

              if (is_null($_POST['organismo_solicitante_id'])){
                $organismo_solicitante_id = 0;
              }else{
              ...
              if (is_null($_POST['sector_sol'])){
                $sector_sol = n;
              }else{
                $sector_sol = strtoupper($_POST['sector_sol']);
              }

              if (is_null($_POST['punto_referencia_sol'])){
                $punto_referencia_sol = n;
              }else{
                $punto_referencia_sol = strtoupper($_POST['punto_referencia_sol']);
              }

              if (is_null($_POST['parroquias_id'])){
                $parroquias_id = 0;
              }else{
              ...
              if (is_null($_POST['detalles_solicitud'])){
                $detalles_solicitud = n;
              }else{
              ...
              if (is_null($_POST['direccion_solicitud'])){
                $direccion_solicitud = n;
              }else{
