                              ...
                              <tbody>
                                ...
                                if ($total_rows_pag != 0) {
                                  ...
                                  do {
                                    ...
                                    // VALORES A COMPARAR
                                    // mktime(0, 1, 0, 5, 24,2024); => mktime(Hora, Min, seg, Mes, Día,Año);
                                    ...
                                    echo "<td><a href=cierre_solicitud_02.php?id=". $reg_pag['id']."&apertura=".$hx7x7." target='_blank'><button class='btn btn-primary' type='submit' action='' value='EDITAR'>EDITAR</button></a></td>\n";
