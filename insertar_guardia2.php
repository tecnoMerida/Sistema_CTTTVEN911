...
if(isset($_POST)){ // Asignamos valores a las variables del POST
                              // Tabla "Solicitante"
              if (isset($_POST['p_nombre_sol'])){
                $p_nombre_sol = strtoupper($_POST['p_nombre_sol']);
              }else{
                $p_nombre_sol = "";
                $p_nombre_sol = $p_nombre_sol;
              }

              if (isset($_POST['p_apellido_sol'])){
                $p_apellido_sol = strtoupper($_POST['p_apellido_sol']);
              }else{
                $p_apellido_sol = "";
                $p_apellido_sol = $p_apellido_sol;
              }

              $telefono_celular_sol = $_POST['telefono_celular_sol'];

              if (isset($_POST['motivo_solicitud_id'])){
                $motivo_solicitud_id = $_POST['motivo_solicitud_id'];
              }else{
                $motivo_solicitud_id = "";
                $motivo_solicitud_id = $motivo_solicitud_id;
              }

              if (isset($_POST['organismo_solicitante_id'])){
                $organismos_solicitud_id = $_POST['organismo_solicitante_id'];
              }else{
                $organismo_solicitante_id = "";
                $organismos_solicitud_id = $organismos_solicitud_id;
              }
              ...
              if (isset($_POST['punto_referencia_sol'])){
                $punto_referencia_sol = strtoupper($_POST['punto_referencia_sol']);
              }else{
                $punto_referencia_sol = 0;
                $punto_referencia_sol = $punto_referencia_sol;
              }
              ...
              if (isset($_POST['detalles_solicitud'])){
              ...
              if (isset($_POST['direccion_solicitud'])){
