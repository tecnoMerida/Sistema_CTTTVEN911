                        ...
                        -->
                              <div class="panel-body">
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6">
                                    <input type="hidden" class="form-control" name="tiempo_apertura_sol" id="tiempo_apertura_sol" placeholder="Tiempo de apertura" required value="<?php echo $tiempo_apertura = date('H:i:s'); ?>" title="Llene este campo con la hora de apertura de la solicitud" />
                                  </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6">
                                    <input type="time" class="form-control" name="hora_sol" id="hora_sol" placeholder="Ingrese hora solicitud" value="<?php echo $hora_sol = date('H:i:s'); ?>" required title="Llene este campo con la hora de llamada de solicitud" readonly />
                                  </div>
                                </div>

                                <div class="field item form-group">
                                  <div class="col-md-6 col-sm-6">
                                    <input type="hidden" class="form-control" name="hora_cierre_sol" id="hora_cierre_sol" placeholder="Ingrese hora cierre" value="<?php echo $hora_sol = date('H:i:s'); ?>" required title="Llene este campo con la hora de cierre de la solicitud" />
                                  </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                  ...
                                  <!-- pertenece al campo de selección de motivo de solicitud -->
                            ...
                            <!--    // **************************
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6">
                                    <select id="motivo_solicitud_id" class="form-control" name="motivo_solicitud_id" title="Seleccione este campo con el motivo de la solicitud">
                                      <option value="0">--Seleccione--</option>
                                      <?php
                                      ...
                                      ?>
                                        <optgroup label="<?php echo $registro44[1] ?>" value="<?php echo $grupo ?>">
                                          ...
                                          while ($registro45 = pg_fetch_array($result45)) {
                                            ...
                                            echo '<option name="id" value="'.$registro45[0].'">'.strtoupper($registro45[1]).'</option>';
                                                                                          }
                                          ?>
                                        </optgroup>
                                      <?php
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6">
                                    <select id="cboSectores" class="form-control" name="sector_sol" title="Seleccione sector en que sucede el evento de solicitud">
                                      <?php
                                      /*
                                      ...
                                      */
                                      ...
                                      <option value="00">-Seleccione Sector-</option>
                                ...
                                // Consulta a la Base de Datos
                                $result5 = pg_query($dbconn, "SELECT * FROM estatus_solicitud WHERE id IN (4,5,6,7)");
                                if (!$result5) {
                                  echo "Ocurrió un error.\n";
                                  exit;
                                }
                                ...
                                <div class="field item form-group">
                                  ...
                                  <div class="col-md-6 col-sm-6">
                                    ...
                                    <input type="varchar" name="" id="" class="form-control" placeholder="Nombre del Operador" value="<?php echo $reg_operador['p_nombre'];
                                                                                                                                      echo " ";
                                                                                                                                      echo $reg_operador['p_apellido']; ?>" minlength="2" maxlength="40" title="Llene este campo con nombre del Operador que recibe la solicitud" pattern="[a-zA-Z0-9àáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð -]{2,40}" readonly />
                                  </div>
                                </div>
