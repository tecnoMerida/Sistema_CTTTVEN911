...
?>
      ...
      <!-- ****************************************************************************************************** -->
      <?php
        $apertura_solicitud = $reg['tiempo_apertura_sol'];
//$formato_apertura = $apertura_solicitud->format('%H:%I:%s');
$hora_apertura = date('H', strtotime($apertura_solicitud));
$minuto_apertura = date('i', strtotime($apertura_solicitud));
$segundo_apertura = date('s', strtotime($apertura_solicitud));
        ?>
...
<!--          <input type="time" class="form-control" name="tiempo_apertura_sol" id="tiempo_apertura_sol" placeholder="Tiempo de apertura" required value="<?php //echo $reg['tiempo_apertura_sol']; ?>" title="Llene este campo con la hora de apertura de la solicitud" readonly />-->
        ...
        <div class="col-md-3 col-sm-3">
          <b>hora</b>
          <input type="number" class="form-control" name="tiempo_respuesta_sol" id="tiempo_respuesta_sol" value="<?php echo $hora_apertura; ?>" title="Rellene este campo con Horas de tiempo de respuesta" readonly />
        </div>

        <div class="col-md-3 col-sm-3">
          <b>minuto</b>
          <input type="number" class="form-control" name="tiempo_respuesta_sol1" id="tiempo_respuesta_sol1" value="<?php echo $minuto_apertura; ?>" title="Rellene este campo con Minutos de tiempo de respuestas" readonly />
        </div>
        <div class="col-md-3 col-sm-3">
          <b>segundo</b>
          <input type="number" class="form-control" name="tiempo_respuesta_sol1" id="tiempo_respuesta_sol1" value="<?php echo $segundo_apertura; ?>" title="Rellene este campo con Minutos de tiempo de respuestas" readonly />
        </div>
        </div>
      </div>
...
<?php
    ...
    //  $result44 = pg_query($dbconn, "SELECT * FROM motivo_solicitud WHERE id = $motivo_sol");
      ...
      <div class="field item form-group">
        ...
        <div class="col-md-6 col-sm-6">
          <input class="form-control" name="motivo_solicitud_id" title="Seleccione este campo con el motivo de la solicitud" value="<?php echo strtoupper($registro44['nombre_motivo_grupo']).' - '.strtoupper($registro44['nombre_motivo']); ?>" readonly>
        </div>
      </div>
      ...
      $result3 = pg_query($dbconn, "SELECT sectores.id, sectores.nombre_sector, parroquias.id, parroquias.nombre_parroquia, municipios.id, municipios.nombre_municipio, estados.id, estados.nombre_estado FROM public.sectores
      ...
      <div class="field item form-group">
        ...
        <div class="col-md-6 col-sm-6">
        <input class="form-control" name="sector_sol" id="cboParroquia" title="Seleccione sector en que sucede el evento de solicitud" value="<?php echo $reg_ciudad['nombre_sector'] ?>" readonly>
        </div>
      </div>
...
/************************************************************** 
 * Calculo de 02 tiempos, realizando una comparación, obteniendo 
 * como resultado la diferencia entre ambos para el tiempo de
 * efectividad de atención de solicitud
****************************************************************/

      $horaInicio = $reg['hora_sol'];
      $horaTermino = $reg['hora_cierre_sol'];
      $datex7 = new DateTime($horaTermino);
      $datex77 = new DateTime($horaInicio);
      $horax7 = date_diff($datex7, $datex77);
      
      $hx7x7 = $horax7->format('%H:%I:%s');
      $tiempo_efectivo01 = date('H', strtotime($hx7x7));
      $tiempo_efectivo02 = date('i', strtotime($hx7x7));

/***************************************************************
 * Segunda comparación de tiempos, para la obtención del
 * tiempo de respueta
 */
$horaInicio2 = $reg['tiempo_apertura_sol'];
$horaTermino2 = $hx7x7;
$datex71 = new DateTime($horaTermino2);
$datex771 = new DateTime($horaInicio2);
$horax71 = date_diff($datex71, $datex771);

$hx7x71 = $horax71->format('%H:%I:%s');
...
echo $hx7x71;
      ...
      <div class="field item form-group">
        ...
        <div class="col-md-2 col-sm-2">
          <b>hora</b>
          <input type="number" class="form-control" name="tiempo_respuesta_sol" id="tiempo_respuesta_sol" value="<?php echo $tiempo_respuesta01; ?>" title="Rellene este campo con Horas de tiempo de respuesta" readonly />
        </div>

        <div class="col-md-2 col-sm-2">
          <b>minuto</b>
          <input type="number" class="form-control" name="tiempo_respuesta_sol1" id="tiempo_respuesta_sol1" value="<?php echo $tiempo_respuesta02; ?>" title="Rellene este campo con Minutos de tiempo de respuestas" readonly />
        </div>
      </div>
<?php

/*
$horaInicio1 = $reg['hora_sol'];
$horaTermino1 = $reg['hora_cierre_sol'];
$date_7 = new DateTime($horaTermino1);
$date_77 = new DateTime($horaInicio1);
$hora_7 = date_diff($date_7, $date_77);

$h_7_7 = $hora_7->format('%H:%I:%s');
$hora_efectiva = date('H', strtotime($h_7_7));
$minuto_efectivo = date('i', strtotime($h_7_7));
*/

      ?>
      <div class="field item form-group">
        <!-- //  tiempo de respuesta de la Solicitud  // -->
        <label class="col-form-label col-md-3 col-sm-3  label-align" for="tiempo_respuesta_sol">Tiempo Efectivo</label>
        <div class="col-md-2 col-sm-2">
          <b>hora</b> 
          <input type="number" class="form-control" name="tiempo_respuesta_sol" id="tiempo_respuesta_sol" value="<?php echo $tiempo_efectivo01; ?>" title="Rellene este campo con Horas de tiempo de respuesta" readonly />
        </div>

        <div class="col-md-2 col-sm-2">
          <b>minuto</b> 
          <input type="number" class="form-control" name="tiempo_respuesta_sol1" id="tiempo_respuesta_sol1" value="<?php echo $tiempo_efectivo02; ?>" title="Rellene este campo con Minutos de tiempo de respuestas" readonly />
        </div>
      </div>
